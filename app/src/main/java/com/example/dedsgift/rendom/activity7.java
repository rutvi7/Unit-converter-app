...
public class activity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsfre, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_fre.Unit fromUnit = Converter_fre.Unit.fromString(fromString);
        Converter_fre.Unit toUnit = Converter_fre.Unit.fromString(toString);

        // Create a Converter_fre object and convert!
        Converter_fre converter = new Converter_fre(fromUnit, toUnit);
