...
public class activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsvolume, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_volume.Unit fromUnit = Converter_volume.Unit.fromString(fromString);
        Converter_volume.Unit toUnit = Converter_volume.Unit.fromString(toString);


        // Create a converter object and convert!
        Converter_volume converter = new Converter_volume(fromUnit, toUnit);
