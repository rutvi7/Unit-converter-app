...
public class activity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitspre, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_pre.Unit fromUnit = Converter_pre.Unit.fromString(fromString);
        Converter_pre.Unit toUnit = Converter_pre.Unit.fromString(toString);

        // Create a Converter_pre object and convert!
        Converter_pre converter = new Converter_pre(fromUnit, toUnit);
