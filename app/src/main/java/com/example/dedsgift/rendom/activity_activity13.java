...
public class activity_activity13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitstds, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_ds.Unit fromUnit = Converter_ds.Unit.fromString(fromString);
        Converter_ds.Unit toUnit = Converter_ds.Unit.fromString(toString);

        // Create a converter object and convert!
        Converter_ds converter = new Converter_ds(fromUnit, toUnit);
