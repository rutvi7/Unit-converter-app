...
public class activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsw, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_weight.Unit fromUnit = Converter_weight.Unit.fromString(fromString);
        Converter_weight.Unit toUnit = Converter_weight.Unit.fromString(toString);

        // Create a converter object and convert!
        Converter_weight converter = new Converter_weight(fromUnit, toUnit);
