...
public class activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsa, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_area.Unit fromUnit = Converter_area.Unit.fromString(fromString);
        Converter_area.Unit toUnit = Converter_area.Unit.fromString(toString);

        // Create a converter object and convert!
        Converter_area converter = new Converter_area(fromUnit, toUnit);
