...
public class activity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsspeed, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_speed.Unit fromUnit = Converter_speed.Unit.fromString(fromString);
        Converter_speed.Unit toUnit = Converter_speed.Unit.fromString(toString);

        // Create a Converter_speed object and convert!
        Converter_speed converter = new Converter_speed(fromUnit, toUnit);
