...
public class activity12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.unitsfuel, android.R.layout.simple_spinner_item);
    ...
    public void convert(View view) {
        ...
        Converter_fuel.Unit fromUnit = Converter_fuel.Unit.fromString(fromString);
        Converter_fuel.Unit toUnit = Converter_fuel.Unit.fromString(toString);

        // Create a Converter_fuel object and convert!
        Converter_fuel converter = new Converter_fuel(fromUnit, toUnit);
